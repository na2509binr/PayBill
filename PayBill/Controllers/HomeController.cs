...
namespace PayBill.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            _clsDb = new clsDb();
            Dishes[] arrDishes = _clsDb.GetList_Dish(-1);
            ...
            Dishes[] arrDish = new Dishes[]
            {
                new Dishes {ID_Dish = 9, Dish_Name="Rượu Sake" ,Dish_Price = "8000"},
                new Dishes {ID_Dish = 2, Dish_Name="Banh my", Dish_Price = "230000"},
                new Dishes {ID_Dish = 5, Dish_Name="Sushi", Dish_Price = "6000"},
                new Dishes {ID_Dish = 7, Dish_Name="Sashimi", Dish_Price = "100000"},
                new Dishes {ID_Dish = 1, Dish_Name="Bánh nhân bạch tuộc Takoyaki", Dish_Price = "20000"},
                new Dishes {ID_Dish = 3, Dish_Name="Lẩu bò Shabu", Dish_Price = "9000"},
                new Dishes {ID_Dish = 8, Dish_Name="Cơm cà ri", Dish_Price = "65000"},
                new Dishes {ID_Dish = 4, Dish_Name="Bach tuoc Nhat", Dish_Price = "2000"},
                new Dishes {ID_Dish = 6, Dish_Name="Okonomiyaki monjayaki", Dish_Price = "8000"}
            };

            GetDataToViewModel getDataModel = new GetDataToViewModel();
            getDataModel.tablesList = arr.ToPagedList<Tables>();
            getDataModel.dishesList = (arrDishes != null) ? arrDishes.ToPagedList<Dishes>() : arrDish.ToPagedList<Dishes>();
        ...
        public IActionResult Employee()
        {
            ...
            GetDataToViewModel getDataModel = new GetDataToViewModel();
            getDataModel.employeeList = (arrEmployee != null) ? arrEmployee.ToPagedList<Employee>() : arr.ToPagedList<Employee>();
            getDataModel.dishesList = (arrDishes != null) ? arrDishes.ToPagedList<Dishes>() : arrDish.ToPagedList<Dishes>();
            getDataModel.message = TempData["Message"] as string;
        ...
        public IActionResult GetReceiptDetails(string html)
        {
            try
            {
                ...
                if (bill != null)
                {
                    ...
                    {
                        totalMoney = decimal.Parse(node.InnerText);
                    }
                }
